// src/main.js
/**
 * Main entry point for IntelligentCryptoNetwork application
 */
...
class IntelligentCryptoNetwork {
    /**
     * Create a new IntelligentCryptoNetwork instance
...
module.exports = IntelligentCryptoNetwork;
...
if (require.main === module) {
    ...
    const app = new IntelligentCryptoNetwork({
        input: args.input,
        output: args.output,
